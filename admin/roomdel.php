        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="demo/add_data.php"><i class="fa fa-plus-circle"></i>Add Stuff Info</a>
                    </li>
                    <li>
                        <a   href="demo/view.php"><i class="fa fa-pencil-square-o"></i> View/Update/Delete Stuff Info</a>
                    </li>
