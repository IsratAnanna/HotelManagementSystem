...
<body>
 ...
 <div class="container">
      ...
      <div id="login">
        ...
        <form method="post">
          ...
          <fieldset class="clearfix">
            ...
            <p><input type="submit" name="sub"  value="Login" href=" href="http://localhost/hotel/admin/index.html"></p>
    ...
    <div class="bottom">  <h3><a href="http://localhost/hotel/index.html">Back to Home</a></h3></div>
